...
// ---- 8. Generated C# species table -------------------------------------------
const csRows = Object.entries(speciesIndex)
  .map(([ix, s]) => `        [${ix}] = "${s.name ?? `pot flower (item ${s.itemId})`}",`)
  .join("\n");
const cs = `// <auto-generated - tools/build-domain-data.mjs - do not edit by hand />
...
`;
writeFileSync(join(root, "BalambGarden", "SpeciesTable.g.cs"), cs);
console.log("SpeciesTable.g.cs written");
